...
public class RSFont extends Rasterizer2D {
    ...
    public RSFont(boolean TypeFont, String s, StreamLoader streamLoader) {
        ...
        for (int l = 0; l < 256; l++) {
            ...
            int i1 = characterWidths[l] = stream_1.get_unsigned_short();
            int j1 = characterHeights[l] = stream_1.get_unsigned_short();
