...
public class SpriteLoader2 {
	...
	public static void loadSprites(StreamLoader archive) {
		try {
			Stream index = new Stream(FileOperations.ReadFile(client.SignLink.findcachedir() + "sprites2.idx"));
			Stream data = new Stream(FileOperations.ReadFile(client.SignLink.findcachedir() + "sprites2.dat"));
