...
public final class Class36 {
   ...
   public static void method529(byte[] abyte0) {
      ...
      stream_2.currentOffset = var27;
      var27 += j;
      Stream stream_3 = new Stream(abyte0);
      stream_3.currentOffset = var27;
      var27 += k;
      Stream stream_4 = new Stream(abyte0);
      stream_4.currentOffset = var27;
      var27 += l;
      ...
      for(int l1 = 0; l1 < k1; ++l1) {
         ...
         for(k3 = 0; k3 < j2; ++k3) {
            ...
            if(j3 > 0) {
               if(class18.anIntArray342[k3] != 0) {
                  for(int c = k3 - 1; c > k2; --c) {
                     if(class18.anIntArray342[c] == 0) {
                        ai[l2] = c;
                        ai1[l2] = 0;
                        ai2[l2] = 0;
                        ai3[l2] = 0;
   ...
   public static Class36 method531(int j) {
      return aClass36Array635 == null?null:aClass36Array635[j];
   }
